 ...
 * @todo Use ZendS3?
 */
class Job_BeamUpload extends Omeka_JobAbstract
{
    private $_item;
    ...
    public function perform()
    {
        ...
        $this->_item = get_item_by_id($this->_options['itemId']); 
    ...
    private function _getMetadataCurlObject($first)
    {
        ...
        $body = show_item_metadata(array('show_empty_elements' => true), $this->_item);
    ...
    private function _getFileCurlObject($first, File $fileToBePut)
    {
        ...
        curl_setopt($cURL, CURLOPT_INFILE, fopen(FILES_DIR . '/' . $fileToBePut->archive_filename, 'r'));
