...
function beam_admin_append_to_items_form_files() {
    ...
    <span><strong>Upload to Internet Archive</strong></span>
    ...
    <br />
    <span><strong>Index at Internet Archive</strong></span>
...
{
    return '
        <div>If you uploaded the files and the Internet Archive has fully processed them, you can view them <strong><a href=http://archive.org/details/' . getBucketName() . " target=\"_blank\">here</a></strong>.</div>
        <br />
        <div>You can view the upload's Internet Archive history and progress <strong><a href=http://archive.org/catalog.php?history=1&identifier=" . getBucketName() .' target="_blank">here</a></strong>.</div>
        <br />
    ';
}
